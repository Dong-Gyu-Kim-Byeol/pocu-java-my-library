...
public final class FixedMaxHeap<T> {
    private static final boolean IS_MIN_HEAP = false;
    ...
    public FixedMaxHeap(final int capacity, final Comparator<T> comparator) {
        this.array = (T[]) new Object[capacity];
        this.comparator = comparator;
    }

    public FixedMaxHeap(final T[] array, final int size, final Comparator<T> comparator) {
        this.array = array;
        this.comparator = comparator;
        this.size = size;
